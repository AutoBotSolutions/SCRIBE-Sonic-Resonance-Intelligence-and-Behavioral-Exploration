...
2. **Get help**: Type `help` in the chat interface
3. **Perform a scan**: Type `/scan` or ask "What did you detect?"

### For Developers
1. **Setup environment**: `./deploy.sh`
...
- Examine the [API documentation](api/)
